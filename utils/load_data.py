...
def load_and_prepare_data_for_llm(args, base_traffic_labels_str, all_class_labels_global_map, tokenizer_for_llm):
    ...
    test_dataset = LLMCSVTrafficDataset(dataset_name, df_test, tokenizer_for_llm, max_seq_len_for_llm, all_class_labels_global_map, feature_cols, is_training_data=False)
    
    return train_dataset, val_dataset, test_dataset, args, all_class_labels_global_map, base_class_global_indices_sorted
