...
def parameter_parser():
    ...
    parser.add_argument("--PRE_MODEL",
                        default="datasetsM/ISCXVPN2016/ft_ckpt") 
    ...
    {
        "VPN-MAIL": "vpn mail", "VPN-STREAMING": "vpnstream", "VPN-VOIP": "vpncall",
        "BROWSING":"web" ,"CHAT":"chat" ,"STREAMING":"stream" ,"MAIL":"mail",
        "FT":"ftp", "VPN-FT":"vpnftp", "VPN-P2P":"vpnshare", "VPN-BROWSING":"vpnweb",
    ...
    parser.add_argument('--ood', type=str, nargs='+', default=['VOIP'])
    ...
    parser.add_argument('--lr_subfit', dest='LEARNING_SUBFIT', type=float, default=5e-3)
    parser.add_argument('--lr_fit', dest='LEARNING_RATE_FIT', type=float, default=1e-3,
    ...
    parser.add_argument('--n_eposub', dest='N_EPOCHS_SUBCLASSIFIER', type=int, default=130,
                        help='Number of epochs for Subclassifier training.')


    # OOD/ID Loss Regularization
    parser.add_argument("--OOD_MARGIN", type=float, default=0.1,
                        help="Margin for the entropy-based OOD loss.")
    parser.add_argument("--LAMBDA_ENTROPY", type=float, default=0.3,
